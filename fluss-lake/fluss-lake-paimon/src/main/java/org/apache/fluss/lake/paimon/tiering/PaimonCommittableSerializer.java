...
/** The serializer of {@link PaimonCommittable}. */
public class PaimonCommittableSerializer implements SimpleVersionedSerializer<PaimonCommittable> {
    ...
    @Override
    public byte[] serialize(PaimonCommittable paimonCommittable) throws IOException {
        ManifestCommittable manifestCommittable = paimonCommittable.manifestCommittable();
        return manifestCommittableSerializer.serialize(manifestCommittable);
    }
