...
import org.apache.fluss.testutils.junit.parameterized.ParameterizedTestExtension;
import org.apache.fluss.testutils.junit.parameterized.Parameters;
...
import static org.apache.fluss.row.BinaryString.blankString;
import static org.apache.fluss.row.BinaryString.fromBytes;
import static org.apache.fluss.utils.DecimalUtils.castFrom;
...
public class BinaryStringTest {
    private final BinaryString empty = fromString("");
    ...
    public void testToBytes() {
        assertThat(fromString("hello").toBytes()).isEqualTo(new byte[] {'h', 'e', 'l', 'l', 'o'});
        assertThat(fromString("").toBytes()).isEqualTo(new byte[0]);
    }
